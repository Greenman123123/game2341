class Level1 {
    constructor() {
        ...
        this.can1.scale = 0.4
        this.can1.velocityX = random(-2,2)
        this.can1.velocityY = random(-2,2)
        

        this.can2 = createSprite(425, 400, 20, 100);
        this.can2.addImage(can2Img)
        this.can2.scale = 0.4
        this.can2.velocityX = random(-2,2)
        this.can2.velocityY = random(-2,2)

        this.can3 = createSprite(145, 250, 100, 20);
        this.can3.addImage(can3Img)
        this.can3.scale = 1.4
        this.can3.velocityX = random(-2,2)
        this.can3.velocityY = random(-2,2)

        this.can4 = createSprite(425, 150, 20, 100);
        this.can4.addImage(can4Img)
        this.can4.scale = 1.3
        this.can4.velocityX = random(-2,2)
        this.can4.velocityY = random(-2,2)

        this.can5 = createSprite(145, 140, 100, 20);
        this.can5.addImage(can5Img)
        this.can5.scale = 0.4
        this.can5.velocityX = random(-2,2)
        this.can5.velocityY = random(-2,2)

        this.can6 = createSprite(425, 250, 100, 20);
        this.can6.addImage(can6Img)
        this.can6.velocityX = random(-2,2)
        this.can6.velocityY = random(-2,2)
